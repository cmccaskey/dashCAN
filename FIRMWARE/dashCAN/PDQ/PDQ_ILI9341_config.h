...
#define	ILI9341_CS_PIN		6			//PB0 <= /CS pin (chip-select, LOW to get attention of ILI9341, HIGH and it ignores SPI bus)
#define	ILI9341_DC_PIN		8			//PD6 <= DC pin (1=data or 0=command indicator line) also called RS
#define	ILI9341_RST_PIN		7			//PD7 <= RST pin (optional)
